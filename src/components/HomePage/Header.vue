...
<!-- 导航栏整体布局 -->
<template>
    <header class="sticky top-0 z-50 flex h-25 items-center gap-4 border-b bg-background  sm:static sm:h-auto sm:border-0 sm:bg-transparent px-10">
        <div class="container mx-auto flex w-full items-center justify-between px-20 sm:px-6">
            <div>
