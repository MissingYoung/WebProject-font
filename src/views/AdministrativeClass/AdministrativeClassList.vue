          ...
          <TableRow v-for="row in tableData" :key="row.id">
            ...
            <TableCell class="text-right">
              <div class="flex flex-wrap justify-end gap-2">
                ...
                >
                  <UserPlus class="h-4 w-4 text-blue-600" />分配学生
                </Button>
                <Button
                ...
                >
                  <Play class="h-4 w-4 text-green-600" />启用
                </Button>
                <Button
                ...
                >
                  <PauseCircle class="h-4 w-4 text-orange-600" />禁用
                </Button>
                <Button
                  variant="ghost"
                  size="sm"
